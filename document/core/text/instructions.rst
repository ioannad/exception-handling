...
.. index:: control instructions, structured control, label, block, branch, result type, label index, function index, type index, vector, polymorphism, exception instructions
...
.. math::
   ...
   \production{block instruction} & \Tblockinstr_I &::=&
     ...
     \text{try}~~I'{:}\Tlabel_I~~\X{rt}{:}\Tresulttype~~(\X{in}_1{:}\Tinstr_{I'})^\ast~~
...
.. math::
   ...
   \production{instruction} & 
     ...
     \text{(}~\text{try}~~\Tlabel~~\Tresulttype~~\Tinstr_1^\ast
       &\hspace{-8ex} \text{(}~\text{catch}~~\Tinstr_2^\ast~\text{)}~\text{)} \quad\equiv \\ &\qquad
       \text{try}~~\Tlabel~~\Tresulttype~~\Tinstr_1^\ast & \hspace{-6ex} \text{catch}~~\Tinstr_2^\ast~\text{end} & \\
   \end{array}
